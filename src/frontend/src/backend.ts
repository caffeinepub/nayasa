...
export class Backend implements backendInterface {
    ...
    async getAllListings(): Promise<Array<PhoneListing>> {
    ...
    async getAllSellerSubmissions(): Promise<Array<SellerSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSellerSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListingById(arg0: bigint): Promise<PhoneListing> {
        if (this.processError) {
            try {
    ...
    async getListingsByBrand(arg0: string): Promise<Array<PhoneListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListingsByBrand(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitSellRequest(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: Array<string>, arg5: string): Promise<SellerSubmission> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSellRequest(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
