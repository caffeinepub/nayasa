...
type Step = "choose" | "phone" | "otp" | "signing-in";
...
export function Login() {
  ...
  const handleSocialSignIn = async (provider: "google" | "outlook") => {
    setSocialLoading(provider);
    setStep("signing-in");
    await new Promise((r) => setTimeout(r, 1500));
    const u = {
      name: provider === "google" ? "Guest User" : "Outlook User",
      email: provider === "google" ? "guest@gmail.com" : "guest@outlook.com",
      phone: "",
    };
    if (actor) {
      try {
              ...
              >
                <div>
                  ...
                  <p className="text-muted-foreground text-sm mt-1">
                    Sign in to track your orders &amp; listings
                  </p>
                </div>
                ...
                <button
                  type="button"
                  data-ocid="login.outlook.button"
                ...
                <p className="text-xs text-muted-foreground text-center">
                  By signing in, you agree to ReGenix's Terms of Service and
                  Privacy Policy
                </p>
              </motion.div>
            )}
            ...
            {step === "phone" && (
              ...
              >
                <div className="flex items-center gap-3">
                  <button
                    type="button"
                    data-ocid="login.phone.back_button"
            ...
            {step === "otp" && (
              ...
              >
                <div className="flex items-center gap-3">
                  <button
                    type="button"
                    data-ocid="login.otp.back_button"
                    onClick={() => setStep("phone")}
                ...
                <div className="flex gap-2 justify-center">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      data-ocid={`login.otp.input.${index + 1}`}
                      type="text"
                      inputMode="numeric"
                      maxLength={1}
                      value={digit}
